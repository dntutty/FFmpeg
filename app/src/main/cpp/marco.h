...
#ifndef FFMPEG_MARCO_H
#define FFMPEG_MARCO_H
...
//定义日志打印宏函数
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR,"GHSFFMPEG",__VA_ARGS__)
...
//根据流信息配置上下文参数失败
#define FFMPEG_CODEC_CONTEXT_PARAMTERS_FAIL (ERROR_CODE_FFMPEG_PREPARE - 5)
//打开解码器失败
